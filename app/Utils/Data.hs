...
-- Filtra a lista de jogos com base nos critérios de plataforma, termo de busca, status de "Quero Jogar" e platinado
filterGames :: [Game] -> T.Text -> T.Text -> Maybe Bool -> Maybe Bool -> [Game]
filterGames games platformFilter searchFilter maybeWantToPlay maybePlatinumed =
    let -- Filtro por plataforma
        ...
        playedFiltered = case maybeWantToPlay of
